                    ...
                    {page.layout !== 'page' ? <div class="article-meta is-size-7 is-uppercase level is-mobile">
                        <div class="level-left">
                            ...
                            {page.categories && page.categories.length ? <span class="level-item">
                                {(() => {
                                    const categories = [<i class="far fa-folder-open has-text-grey">&nbsp;</i>];
                            ...
                            {article && article.readtime && article.readtime === true ? <span class="level-item">
                                {(() => {
                                    ...
                                    return [<i class="far fa-clock">&nbsp;</i>, `${_p('article.read_time', time.locale(index ? indexLaunguage : language).humanize())} (${_p('article.word_count', words)})`];
                                })()}
                            </span> : null}

                            {/* Visitor counter */}
                            {!index && plugins && plugins.busuanzi === true ? <span class="level-item" id="busuanzi_container_page_pv" dangerouslySetInnerHTML={{
                                __html: `<i class="far fa-eye">&nbsp;</i>${_p('plugin.visit_count', '<span id="busuanzi_value_page_pv">0</span>')}`
                            }}></span> : null}
                        </div>
                    </div> : null}
